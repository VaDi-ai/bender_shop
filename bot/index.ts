...
// («Ещё → Аналитика»). Инлайн-хендлеры остаются для старых кнопок в чатах.
...
// ─── 💰 Цены ──────────────────────────────────────────────────────────────────
// Кнопка убрана (фаза 2): разбор прайсов, наценка и поставщики — в мини-аппе,
// курс USD — информером на «Сегодня» (обновляется ежедневным кроном ниже).
// Инлайн-хендлеры (в т.ч. коррекция цен из утреннего алерта) остаются.
