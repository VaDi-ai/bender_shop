...
exports.HeroBannerScalarFieldEnum = {
    id: 'id',
    imageFile: 'imageFile',
    title: 'title',
    subtitle: 'subtitle',
...
exports.BroadcastLogScalarFieldEnum = {
    id: 'id',
    type: 'type',
    target: 'target',
...
exports.PriceChangeScalarFieldEnum = {
    id: 'id',
    variantId: 'variantId',
    oldPrice: 'oldPrice',
    newPrice: 'newPrice',
...
exports.CurrencyRateScalarFieldEnum = {
    id: 'id',
    currency: 'currency',
    rate: 'rate',
...
exports.SecurityLogScalarFieldEnum = {
    id: 'id',
    event: 'event',
    details: 'details',
    ip: 'ip',
